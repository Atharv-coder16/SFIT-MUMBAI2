      ...
      <div style={{ position: 'relative', height: 70 }}>
        ...
        <div
          style={{
            ...
            color: isHovered ? 'rgba(107,114,128,0.15)' : '#6b7280',
            letterSpacing: '-0.5px',
            lineHeight: 1.2,
            userSelect: 'none',
            whiteSpace: 'nowrap',
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        >
          <TextRevealCardTitle>
            Intelligence that satisfies the interest before a missed payment can.
          </TextRevealCardTitle>
          <TextRevealCardDescription>
            Our ensemble AI engine analyzes 360° behavioral signals in real time
            — turning early stress patterns into pre-delinquency interventions.
          </TextRevealCardDescription>
        </TextRevealCard>
      </div>
