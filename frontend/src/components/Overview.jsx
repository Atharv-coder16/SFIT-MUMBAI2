...
export default function Overview({ clock }) {
  ...
  return (
    <div style={{ animation: 'fadeSlideUp 600ms ease' }}>
      ...
      {/* ═══ Risk Radar Command Center Toggle ═══ */}
      <div style={{ marginTop: 32, textAlign: 'center' }}>
        <button
          ...
          style={{
            ...
            border: showRadar ? '1px solid rgba(255,71,87,0.4)' : '1px solid rgba(0,212,255,0.3)',
            ...
            boxShadow: showRadar
              ? '0 0 20px rgba(255,71,87,0.15), inset 0 0 20px rgba(255,71,87,0.05)'
              : '0 0 20px rgba(0,212,255,0.15), inset 0 0 20px rgba(0,212,255,0.05)',
          }}
          onMouseEnter={e => {
            e.target.style.transform = 'scale(1.04)';
            e.target.style.boxShadow = showRadar
              ? '0 0 30px rgba(255,71,87,0.3), inset 0 0 20px rgba(255,71,87,0.1)'
        ...
        >
          {showRadar ? '✕ Close Risk Radar' : '🔴 Open Risk Radar Command Center'}
        </button>
      </div>

      {showRadar && (
        <div style={{ marginTop: 24, animation: 'fadeSlideUp 500ms ease' }}>
          <RiskRadarDashboard />
        </div>
      )}
    </div>
